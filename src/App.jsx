...
export default function App() {
  ...
  function resultado(){
    if(numeroUm != '' && numeroDois != '' && simbulo != '='){
      if(simbulo === '/'){
    ...
    <div className='content'>
      <div className='calculadora'>
        <div className='calculadoraHeader'>
          ...
          <p className='solucao'>{simbulo} {numeroUm}</p>
        </div>
        <div className='botoes'>
          ...
          <div className='linhas'>
            ...
            <Botao text={'X'} background={'#005DB2'} color={'#339DFF'} onClick={() => conta('*')} />
          </div>
          <div className='linhas'>
          ...
          <div className='linhas'>
            ...
            <Botao text={'.'} background={'#616161'} color={'#29A8FF'} onClick={adicionarPonto} />
